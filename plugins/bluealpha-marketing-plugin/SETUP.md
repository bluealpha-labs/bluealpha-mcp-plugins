...
Two pieces to install: the **BlueAlpha MCP** connector (so Claude can read your Google Ads, Meta Ads, TikTok Ads, LinkedIn Ads, and Meridian MMM data) and the **BlueAlpha Marketing Plugin** (the 51 skills that use it). Total time: about a minute.
